...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase>
{
	...
	public void initialise()
	{
		...
		registerPacket(PacketAccuracyInADS.class);
		registerPacket(PacketDefaultAccuracy.class);
		registerPacket(PacketVehicleInteraction.class);
		registerPacket(PacketOpenRadarGui.class);
		registerPacket(PacketRadio.class);
		registerPacket(PacketSync.class);
		registerPacket(PacketDeleteVehicle.class);
		registerPacket(PacketEjectPlayers.class);
		registerPacket(PacketSpawnVehicle.class);
		registerPacket(PacketInitialiseVehicleGui.class);
		registerPacket(PacketBuySlot.class);
		registerPacket(PacketCYLRPSound.class);
