...
public class DriveableType extends InfoType
{
	...
	public String lockOnSound = "flansmod:Lock";
	public String lockOffSound = "flansmod:Unlock";
	
	public String klaxonSound = "flansmod:Klaxon";
	public String sirenSound = "flansmod:Siren";
    ...
    public ArrayList<ItemStack> getItemsRequired(DriveablePart part, PartType engine)
    {
    	...
    	for(PilotGun gun : pilotGuns)
    	{
    		if(gun.part == part.type)
    			if(gun.type != null && gun.type.item != null) stacks.add(new ItemStack(gun.type.item));
    	}
    	for(Seat seat : seats)
    	{
