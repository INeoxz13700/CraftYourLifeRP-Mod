...
public class EntityPlane extends EntityDriveable
{
	...
	public EntityPlane(World world, double x, double y, double z,EntityPlayer p, PlaneType type, DriveableData data, ItemStack is)
	{
		super(world, type, data);
	    ...
	    data.placerName = p.getCommandSenderName();
	}
