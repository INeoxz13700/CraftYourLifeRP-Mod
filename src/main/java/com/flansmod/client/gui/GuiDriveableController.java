...
public class GuiDriveableController extends GuiScreen
{
	...
	public void handleInput()
    {
		...
		if(plane != null && !plane.isDead() && plane.getControllingEntity() != null && plane.getControllingEntity() instanceof EntityPlayer)
		{
			...
			if(FlansMod.proxy.keyDown(KeyInputHandler.klaxonKey.getKeyCode()))
			{
			...
			if(FlansMod.proxy.keyDown(KeyInputHandler.radioKey.getKeyCode()))
			{
				plane.pressKey(17, player);
			}
			/*if(FlansMod.proxy.keyDown(KeyInputHandler.sirenKey.getKeyCode()))
			{
