...
public class ModelCylrpGlasses extends ModelBaseHead {
	

	public IModelCustom model;
		
	
	public ResourceLocation texture = new ResourceLocation("craftyourliferp","cosmetics/CYLRPGlasses.png");
	

	public ModelCylrpGlasses()
	{
		model = AdvancedModelLoader.loadModel(new ResourceLocation("craftyourliferp","cosmetics/CYLRPGlasses.obj"));
		this.modelScaleX = this.modelScaleY = this.modelScaleZ = 1F;
		this.modelTranslationY = 0.01F;
	}
