...
public class ModelWitchHat2 extends ModelBaseHead {
	
	private static ResourceLocation texture = new ResourceLocation("craftyourliferp","cosmetics/witch_hat2.png");
	...
	public void setRotationAngle(ModelRenderer modelRenderer, float x, float y, float z) {
	 ...
	 {	 
		    ...
		    if(RendererListener.modelPlayer != null && !RendererListener.modelPlayer.bipedHeadwear.isHidden)
		    {
			    GL11.glScalef(6.7F, 6.7F, 6.7F);		    	
		    }
		    else
		    {
