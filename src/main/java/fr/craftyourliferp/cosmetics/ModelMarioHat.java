...
public class ModelMarioHat extends ModelBaseHead {
	
	private static ResourceLocation texture = new ResourceLocation("craftyourliferp","cosmetics/mario_hat.png");
	...
	public ModelMarioHat() {
		...
		this.modelTranslationY = -1.55F;
		this.modelTranslationZ = -0.05F;
	}
