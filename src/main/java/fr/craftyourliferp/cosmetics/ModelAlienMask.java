...
public class ModelAlienMask extends ModelBaseHead {
	
	private static ResourceLocation texture = new ResourceLocation("craftyourliferp","cosmetics/alien_mask.png");
