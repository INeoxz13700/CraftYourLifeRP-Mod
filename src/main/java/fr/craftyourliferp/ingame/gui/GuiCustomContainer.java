...
public abstract class GuiCustomContainer extends GuiScreen
{
    ...
    public GuiCustomContainer(Container p_i1072_1_)
    {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            ...
            if(i1 == 36)
            {
            	GuiUtils.drawImageWithTransparency(slot.xDisplayPosition, slot.yDisplayPosition, new ResourceLocation("craftyourliferp","textures/gui/container/bullet_proof_shield.png"), 16, 16);
            }
