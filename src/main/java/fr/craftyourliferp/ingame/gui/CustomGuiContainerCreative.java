...
public class CustomGuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public CustomGuiContainerCreative(EntityPlayer p_i1088_1_)
    {
        super(new CustomGuiContainerCreative.ContainerCreative(p_i1088_1_));
    ...
    public void updateScreen()
    {
        ...
        {
            this.mc.displayGuiScreen(new GuiInventoryRP(this.mc.thePlayer));
        }
    }
        ...
        else
        {
            ...
            else
            {
                ...
                if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
                {
                    ...
                    {
                        this.mc.thePlayer.inventoryContainer.slotClick(p_146984_1_ == null ? p_146984_2_ : ((CustomGuiContainerCreative.CreativeSlot)p_146984_1_).field_148332_b.slotNumber, p_146984_3_, p_146984_4_, this.mc.thePlayer);
    ...
    {
        CustomGuiContainerCreative.ContainerCreative containercreative = (CustomGuiContainerCreative.ContainerCreative)this.inventorySlots;
    ...
    private void updateFilteredItems(CustomGuiContainerCreative.ContainerCreative containercreative)
    {
        Iterator iterator;
    ...
    private boolean needsScrollBars()
    {
        ...
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((CustomGuiContainerCreative.ContainerCreative)this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory)
        {
            ...
            {
                CustomGuiContainerCreative.CreativeSlot creativeslot = new CustomGuiContainerCreative.CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    public void handleMouseInput()
    {
        ...
        {
            int j = ((CustomGuiContainerCreative.ContainerCreative)this.inventorySlots).itemList.size() / 9 - 5 + 1;
            ...
            ((CustomGuiContainerCreative.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        if (creativetabs == CreativeTabs.tabInventory)
        {
            GuiInventoryRP.func_147046_a(this.guiLeft + 43, this.guiTop + 45, 20, (float)(this.guiLeft + 43 - p_146976_2_), (float)(this.guiTop + 45 - 30 - p_146976_3_), this.mc.thePlayer);
        }
    }
    ...
    static class ContainerCreative extends Container
        {
            ...
            public ContainerCreative(EntityPlayer p_i1086_1_)
            {
                ...
                for (i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 9; ++j)
                    {
                        this.addSlotToContainer(new Slot(CustomGuiContainerCreative.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                    }
                }
            ...
            public void scrollTo(float p_148329_1_)
            {
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        {
                            CustomGuiContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                        }
                        else
                        {
                            CustomGuiContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)null);
                        }
                    }
                }
            }
