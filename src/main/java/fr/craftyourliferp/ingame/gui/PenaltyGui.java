...
import com.flansmod.common.network.PacketPenalty;
...
public class PenaltyGui extends GuiScrollableView {
	...
	public void  initGui()
	{
		...
		FlansMod.packetHandler.sendToServer(guiElementsSync);
	}
	...
	public void initializeComponent()
	{
		...
		addComponent(new UIText("Mes amendes",new UIColor(80,80,80),1.2f).setPosition(getWindowPosX() + 14, getWindowPosY() + 15, 0, 0));
		
		addComponent(new UIText("Date ",new UIColor(80,80,80),1f).setPosition(getWindowPosX() + getWindowWidth() - 110, getWindowPosY() + 40, 0, 0));
		addComponent(new UIText("Raison ",new UIColor(80,80,80),1f).setPosition(getWindowPosX() + getWindowWidth() - 110, getWindowPosY() + 55, 0, 0));
		addComponent(new UIText("Prix ",new UIColor(80,80,80),1f).setPosition(getWindowPosX() + getWindowWidth() - 110, getWindowPosY() + 70, 0, 0));
		addComponent(new UIText("Id ",new UIColor(80,80,80),1f).setPosition(getWindowPosX() + getWindowWidth() - 110, getWindowPosY() + 85, 0, 0));

		addComponent(new UIText("Total : " + totalPrice + " €",new UIColor(80,80,80),1f).setPosition(getWindowPosX() + getWindowWidth() - 108, getWindowPosY() + getWindowHeight() - 50, 0, 0));
		
		
		addComponent(new UIButton(Type.SQUARE,new UIRect(new UIColor(37, 154, 247)),"Payer",new UIRect(new UIColor(35, 131, 207)),new UIButton.CallBackObject()
		{
			@Override
			public void call()
			{
	...
	public void updateScreen()
	{
		...
		if(getGuiTicks() % 20 == 0)
		{
			...
			{
				if(guiElementsSync.received) FlansMod.packetHandler.sendToServer(guiElementsSync);
			}
		}
		super.updateScreen();
	...
	{
		FlansMod.packetHandler.sendToServer(PacketPenalty.payPenalties(getSelectedPenaltiesId()));
		unSelectAll();
		selectedObj = null;
	}
...
class PenaltyObject extends UIButton
{
	...
	public PenaltyObject(PenaltyGui gui,String name,Penalty penalty) {
		super(Type.SQUARE, new UIRect(new UIColor(37, 154, 247)), name, new UIRect(new UIColor(35, 131, 207)),null);
