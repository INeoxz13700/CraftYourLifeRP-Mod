...
public class BlockGoldIngot extends BlockContainer {
    ...
    public TileEntity createNewTileEntity(World world, int par2) {
    	TileEntityGoldIngot painting = new TileEntityGoldIngot();
        return painting;
    }
    ...
    {
    	TileEntityGoldIngot tile = (TileEntityGoldIngot) blockAccess.getTileEntity(x, y, z);
        this.setBlockBounds(0.1f, 0, 0.1f, 0.9f, 0.5f, 0.9f);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
	    ...
	    if(tile instanceof TileEntityGoldIngot)
	    {
	    	...
	    	{	    
		    	...
		    	{
		    		player.addChatMessage(new ChatComponentText("§cCe Lingot est déjà entrain d'être volé"));
		    		return true;
		    	}
		    	...
		    	tilep.setStealingEntity(player);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
    	...
    	TileEntityGoldIngot tile = (TileEntityGoldIngot) world.getTileEntity(x, y, z);
