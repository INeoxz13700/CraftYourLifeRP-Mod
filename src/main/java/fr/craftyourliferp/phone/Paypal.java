...
import fr.craftyourliferp.network.PacketPaypal;
...
public class Paypal extends Apps 
{
	...
	public Paypal(String name, ResourceLocation ico, GuiPhone phone) 
	{
	...
	public void initializeComponent()
	{
		...
		if(currentPage == null)
		{
			...
			addComponent(new UIImage(new ResourceLocation("craftyourliferp","gui/phone/paypal-ico.png")).setPosition(getWindowPosX() + (getWindowWidth() - 30) / 2, getWindowPosY() + 10, 30, 30));
	
			addComponent(new UIText("Application de paiement\\n         sécurisé",new UIColor("#3d3e40"),0.8f).setPosition(getWindowPosX() + 13, getWindowPosY() + 60));
			
			addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Connexion", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
			{
			...
			addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Ouvrir un compte", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
			{
	...
	public void initGui()
	{
		CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.syncPaypalData(Minecraft.getMinecraft().thePlayer));
	...
	public void displayError(String message, int formIndex)
	{
		...
		UIText text = (UIText) addComponent(new UIText(message,new UIColor("#fc1c14"),0.6f).setTextCenter(true).setPosition(getWindowPosX() + getWindowWidth() / 2, object.getY()+5));
	...
	public class PaypalRegistering implements PaypalApps
	{
		...
		public void init()
		{
			...
			addComponent(new UIImage(new ResourceLocation("craftyourliferp","gui/phone/back.png")).setPosition(getWindowPosX() + 5, getWindowPosY() + 5, 15, 15));
			addComponent(new UIImage(new ResourceLocation("craftyourliferp","gui/phone/paypal-ico.png")).setPosition(getWindowPosX() + (getWindowWidth() - 20) / 2, getWindowPosY() + 10, 20, 20));
			...
			{
				addComponent(new UIText("Quel est votre numéro de \\nmobile ?",new UIColor("#242624"),0.8f).setPosition(getWindowPosX() + 6, getWindowPosY() + 55));
				addComponent(new UIText("Nous devrons le confirmer en \\nvous envoyant un SMS",new UIColor("#8d8f8d"),0.7f).setPosition(getWindowPosX() + 6, getWindowPosY() + 75));
				
				addComponent(new UIText("Numéro de téléphone",new UIColor("#009CDE"),0.7f).setPosition(getWindowPosX() + 10, getWindowPosY() + 90));
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Valider", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					...
					public void call()
					{
						...
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.startRegistration(numberField.getText()));
					}
			...
			else if(registeringStep == 1)
			{
				...
				addComponent(new UIText("Entrez le code",new UIColor("#242624"),1f).setTextCenter(true).setPosition(getWindowPosX() + getWindowWidth() / 2, getWindowPosY() + 50));
				addComponent(new UIText("Nous vous avons envoyé \\n   un code à 6 chiffres",new UIColor(80,80,80),0.8f).setPosition(getWindowPosX() + 10, getWindowPosY() + 70));
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Renvoyer le code", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					
					@Override
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.startRegistration(phoneNumber));
					}
					
				}).setPosition(getWindowPosX() + (getWindowWidth() - 80) / 2, getWindowPosY() + 117, 80, 15).setZIndex(900));
				
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Suivant", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					
					@Override
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.sendActivationCode(textField.getText()));
					}
			...
			else if(registeringStep == 2)
			{
				...
				addComponent(new UIText("Informations de connexion",new UIColor("#242624"),0.8f).setPosition(getWindowPosX() + 5, getWindowPosY() + 45));
				addComponent(new UIText("Gardez-les en sécurité.",new UIColor(80,80,80),0.6f).setPosition(getWindowPosX() + 5, getWindowPosY() + 56));
				
				addComponent(new UIText("Mots de passe",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 68));
				...
				addComponent(new UIText("Confirmation",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 105));
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Suivant", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					...
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.finalizeRegistering(passwordTextField.getText(), confirmationTextField.getText()));
					}
	...
	public class PaypalConnexion implements PaypalApps
	{
		...
		public void init()
		{
			...
			if(guiType == 0)
			{								
				addComponent(new UIText("Numéro de telephone",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 50));
				...
				addComponent(new UIText("Mots de passe",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 87));
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Suivant", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					...
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.connectAccount(numberTextField.getText(), passwordTextField.getText()));
					}
			...
			else if(guiType == 1)
			{
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Valider", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					...
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.startForgotPasswordRequest(phoneTextField.getText()));
					}
			...
			{				
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Suivant", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					...
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.sendCode(textField.getText()));
					}
			...
			{
				addComponent(new UIText("Mots de passe",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 50));
				...
				addComponent(new UIText("Confirmation",new UIColor("#0086D3"),0.55f).setPosition(getWindowPosX() + 5, getWindowPosY() + 87));
				...
				addComponent(new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Changer", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
					
					@Override
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.changePassword(passwordField.getText(), confirmationField.getText()));
					}
	...
	public class PaypalAccount implements PaypalApps
	{
		...
		public void init()
		{
			...
			addComponent(new UIImage(new ResourceLocation("craftyourliferp","gui/phone/paypal-ico.png")).setPosition(getWindowPosX() + (getWindowWidth() - 15) / 2, getWindowPosY() + 3, 15, 15));
			addComponent(new UIRect(new UIColor(180,180,180))).setPosition(getWindowPosX(), getWindowPosY()+21, getWindowWidth(), 2);
			
			addComponent(new UIButton(UIButton.Type.SQUARE, "logout", new ResourceLocation("craftyourliferp","gui/phone/logout.png"), null,false,new UIButton.CallBackObject()
			{
				
				@Override
				public void call()
				{
					CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.disconnectAccount());
				}
		...
		class MoneyDisplayContainer extends UIRect implements IGuiClickableElement
		{
			...
			private UIText sold = new UIText(ServerUtils.getMoneyDisplay("%.2f",Minecraft.getMinecraft().thePlayer) + " EUR",new UIColor(150,150,150),1f);
			...
			public MoneyDisplayContainer() 
			{
				...
				sendBtn = new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Envoyer de l'argent", new UIRect(new UIColor(20,20,209)),new UIButton.CallBackObject()
				{
			...
			public GraphicObject setPosition(int x, int y, int width, int height)
			{
				...
				sold.setPosition(x+5, y+20);
				text.setPosition(x+5, y+32);
		...
		class SendMoneyContainer extends UIRect implements IGuiKeytypeElement, IGuiClickableElement
		{
			...
			private UIText title = new UIText("Solde",new UIColor("#009CDE"),0.8f);
			private UIText sold = new UIText(ServerUtils.getMoneyDisplay("%.2f",Minecraft.getMinecraft().thePlayer) + " EUR",new UIColor(80,80,80),1.1f).setTextCenter(true);
			private UIText text = new UIText("Disponible",new UIColor(100,100,100),0.7f).setTextCenter(true);
			...
			public SendMoneyContainer() 
			{
				...
				sendBtn = new UIButton(UIButton.Type.SQUARE, new UIRect(new UIColor(40,68,209)), "Envoyer", new UIRect(new UIColor(130, 148, 237)),new UIButton.CallBackObject()
				{
					
					@Override
					public void call()
					{
						CraftYourLifeRPMod.packetHandler.sendToServer(PacketPaypal.sendMoney(Float.parseFloat(moneyField.getText()), numberField.getText()));
					}
			...
			{
				title.setPosition(x + 5, y + 5);
				sold.setPosition(x + width / 2, y+22);
				text.setPosition(x + width / 2, y+34);
