...
public class SmsObject extends UIImage {
	...
	public SmsObject(SmsData data, boolean senderIsClient)
	{
		...
		if(senderIsClient)
		{
			texture = new ResourceLocation("craftyourliferp","gui/phone/bubble_orange.png");
		}
		else
		{
			texture = new ResourceLocation("craftyourliferp","gui/phone/bubble_blue.png");
		}
	...
	public void draw(int x, int y)
	{
		...
		for(String word : array)
		{
			...
			GuiUtils.renderText(word, posX + 3, tempy + 1,GuiUtils.gameColor,Sms.font_scale);
		...
		{
			GL11.glColor3f(1, 1, 1);
			GuiUtils.drawImage(posX-18, posY, new ResourceLocation("craftyourliferp","gui/phone/profil.png"), 15, 15);
		}
	}
