...
public class ItemExtincteurRenderer implements IItemRenderer {

	private IModelCustom model;
	private ResourceLocation texture;
	
	
	public ItemExtincteurRenderer()
	{
        texture = new ResourceLocation("craftyourliferp","textures/items/Extincteur.png");
        model = AdvancedModelLoader.loadModel(new ResourceLocation("craftyourliferp", "items/models/Extincteur.obj"));
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		switch (type) {
		 ...
		 case INVENTORY: {
			 renderItemInInventory(-0.2F, -0.3F, 0F);
			 break;
		 }
		 default:
			 break;
