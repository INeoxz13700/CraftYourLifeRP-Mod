...
public class ItemCashRegisterRenderer implements IItemRenderer {
	...
	public ItemCashRegisterRenderer(TileEntityCashRegisterRenderer renderer)
	{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		switch (type) {
		 ...
		 case INVENTORY: {
			 renderItemInInventory(0F, -0.3F, 0F);
			 break;
		 }
		 default:
			 break;
