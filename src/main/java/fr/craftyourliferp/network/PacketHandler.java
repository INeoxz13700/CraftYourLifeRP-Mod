...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase>
{
	...
	{
		channels = NetworkRegistry.INSTANCE.newChannel("CYLRP", this);		
		
		registerPacket(PacketMessageDisplay.class);
		registerPacket(PacketSyncShield.class);
		registerPacket(PacketAtm.class);
		registerPacket(PacketSyncPhone.class);
		registerPacket(PacketSendSms.class);
		registerPacket(PacketOpenCharacterGui.class);
		registerPacket(PacketUpdateIdentity.class);
		registerPacket(PacketSyncIdentity.class);
		registerPacket(PacketOpenCardIdentity.class);
		...
		registerPacket(PacketExtinguisher.class);
