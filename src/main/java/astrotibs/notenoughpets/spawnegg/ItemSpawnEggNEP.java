...
public class ItemSpawnEggNEP extends Item
{
	...
	{
		setHasSubtypes(true);
		setCreativeTab(ModNotEnoughPets.spawnEggTabNEC);
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10) {
		...
		else
		{
			...
			if(exp.petsOwned.size() > 0)
			{
				ServerUtils.sendChatMessage(player, "§cVous avez déjà un animal de compagnie.");
				return false;
			}
			...
			Entity entity = spawnCreature(player, world, itemStack, (double)x + Reference.SPAWN_BLOCK_OFFSET, (double)y + d0, (double)z + Reference.SPAWN_BLOCK_OFFSET);
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		...
		else
		{
			...
			if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
			{
				...
				{
					Entity entity = spawnCreature(player, world, stack, (double)x, (double)y, (double)z);
     ...
     */
    public static Entity spawnCreature(EntityPlayer spawner, World world, ItemStack stack, double x, double y, double z)
    {
