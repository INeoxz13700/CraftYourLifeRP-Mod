...
public class MathHelper18
{
    ...
    /**
     * Returns the angle, in radians, given two orthogonal displacements.
     * sides of a right triangle
     */
    public static double atan2(double dy, double dx)
    {
        double hypot_sqrd = dx * dx + dy * dy;

        if (Double.isNaN(hypot_sqrd))
        {
            return Double.NaN;
        }
        else
        {
            boolean flag = dy < 0.0D;
