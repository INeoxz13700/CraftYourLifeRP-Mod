package astrotibs.notenoughpets.client.render.minecraft;
...
/**
 * Copied over from RenderLiving
 */
@SideOnly(Side.CLIENT)
public class RenderLivingNEP extends RenderLiving
{
	public RenderLivingNEP(ModelBase p_i1262_1_, float p_i1262_2_)
	{
		super(p_i1262_1_, p_i1262_2_);
        this.mainModel = p_i1262_1_;
        this.shadowSize = p_i1262_2_;
	}
	
	/*
	 * Stuff pasted in from RenderLiving
	 */
    ...
    /*
     * Stuff pasted in from RendererLivingEntity
     */
