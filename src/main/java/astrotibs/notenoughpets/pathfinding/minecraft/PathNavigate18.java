...
// Pasted in from 1.8
public abstract class PathNavigate18 extends PathNavigate
{
    ...
    public PathNavigate18(EntityLiving entitylivingIn, World worldIn)
    {
    ...
    public PathEntity getPathToPos(BlockPos pos)
    {
        ...
        else
        {
            ...
            int i = (int)(f + 8.0F);
            ChunkCache chunkcache = new ChunkCache(this.worldObj,
            		blockpos.getX()-i, blockpos.getY()-i, blockpos.getZ()-i,
            		blockpos.getX()+i, blockpos.getY()+i, blockpos.getZ()+i, 0);
